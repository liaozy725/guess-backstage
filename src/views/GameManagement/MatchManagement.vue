  ...
  <div class="recharge">
    ...
    <div class="search clearfix">
      ...
      <div class="oneTerm">
        ...
        <div class="serchBtn  pan-btn green-btn" @click="visibleTeam=true;">添加赛事</div>
      </div>
    </div>
    ...
    <el-card class="box-card">
      <el-table :data="tableData" style="width: 100%" stripe fit highlight-current-row v-loading="tableLoding">
        ...
        <el-table-column prop="nickName" label="介绍" header-align="center" align="center"></el-table-column>
    ...
    <el-dialog :visible.sync="visibleTeam" title="添加赛事" center top="10vh">
      <el-form :model="formData" :rules="callRules" ref="call" label-width="90px" class="demo-dynamic">
        ...
        <el-form-item prop="memo" label="介绍">
          <el-input placeholder="请输入赛事介绍" type="textarea" v-model="formData.teamNun"></el-input>
        </el-form-item>
      </el-form>
